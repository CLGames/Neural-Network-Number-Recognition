...
The model was first trained to 98.03% accuracy on the MNIST dataset, then I created a basic windows forms application to allow a user to draw in a digit and have the neural network predict which digit was drawn.
